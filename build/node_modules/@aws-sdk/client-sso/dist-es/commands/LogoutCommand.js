...
class LogoutCommand extends _smithyClient.Command {
  ...
  resolveMiddleware(clientStack, configuration, options) {
    ...
    this.middlewareStack.use((0, _middlewareEndpoint.getEndpointPlugin)(configuration, LogoutCommand.getEndpointParameterInstructions()));
    ...
    const handlerExecutionContext = {
      ...
      clientName,
      commandName,
      inputFilterSensitiveLog: _models_.LogoutRequestFilterSensitiveLog,
  ...
  serialize(input, context) {
    return (0, _Aws_restJson.se_LogoutCommand)(input, context);
  }
  deserialize(output, context) {
    return (0, _Aws_restJson.de_LogoutCommand)(output, context);
  }
}
