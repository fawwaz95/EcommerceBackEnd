...
const de_ExpiredTokenExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.ExpiredTokenException({
...
const de_IDPCommunicationErrorExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.IDPCommunicationErrorException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_IDPRejectedClaimExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.IDPRejectedClaimException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_InvalidAuthorizationMessageExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.InvalidAuthorizationMessageException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_InvalidIdentityTokenExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.InvalidIdentityTokenException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_MalformedPolicyDocumentExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.MalformedPolicyDocumentException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_PackedPolicyTooLargeExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.PackedPolicyTooLargeException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_RegionDisabledExceptionRes = async (parsedOutput, context) => {
  ...
  const exception = new _models_.RegionDisabledException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const throwDefaultError = (0, _smithyClient.withBaseException)(_STSServiceException.STSServiceException);
...
const buildFormUrlencodedString = formEntries => Object.entries(formEntries).map(([key, value]) => (0, _smithyClient.extendedEncodeURIComponent)(key) + "=" + (0, _smithyClient.extendedEncodeURIComponent)(value)).join("&");
