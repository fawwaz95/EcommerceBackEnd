...
const getDefaultRoleAssumer = (stsOptions, stsClientCtor) => {
  ...
  return async (sourceCreds, params) => {
    ...
    const {
      Credentials
    } = await stsClient.send(new _AssumeRoleCommand.AssumeRoleCommand(params));
...
const getDefaultRoleAssumerWithWebIdentity = (stsOptions, stsClientCtor) => {
  ...
  return async params => {
    ...
    const {
      Credentials
    } = await stsClient.send(new _AssumeRoleWithWebIdentityCommand.AssumeRoleWithWebIdentityCommand(params));
    if (!Credentials || !Credentials.AccessKeyId || !Credentials.SecretAccessKey) {
