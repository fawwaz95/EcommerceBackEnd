...
const se_CreateIdentityPoolCommand = async (input, context) => {
  ...
  let body;
  body = JSON.stringify((0, _smithyClient._json)(input));
...
const de_CreateIdentityPoolCommand = async (output, context) => {
  ...
  let contents = {};
  contents = (0, _smithyClient._json)(data);
  const response = {
...
const de_ConcurrentModificationExceptionRes = async (parsedOutput, context) => {
  ...
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.ConcurrentModificationException({
...
const de_DeveloperUserAlreadyRegisteredExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.DeveloperUserAlreadyRegisteredException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_ExternalServiceExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.ExternalServiceException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_InternalErrorExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.InternalErrorException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_InvalidIdentityPoolConfigurationExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.InvalidIdentityPoolConfigurationException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_InvalidParameterExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.InvalidParameterException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_LimitExceededExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.LimitExceededException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_NotAuthorizedExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.NotAuthorizedException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_ResourceConflictExceptionRes = async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, _smithyClient._json)(body);
  const exception = new _models_.ResourceConflictException({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, _smithyClient.decorateServiceException)(exception, body);
...
const de_Credentials = (output, context) => {
  return (0, _smithyClient.take)(output, {
    AccessKeyId: _smithyClient.expectString,
    Expiration: _ => (0, _smithyClient.expectNonNull)((0, _smithyClient.parseEpochTimestamp)((0, _smithyClient.expectNumber)(_))),
    SecretKey: _smithyClient.expectString,
    SessionToken: _smithyClient.expectString
  });
};
const de_GetCredentialsForIdentityResponse = (output, context) => {
  return (0, _smithyClient.take)(output, {
    Credentials: _ => de_Credentials(_, context),
    IdentityId: _smithyClient.expectString
  });
};
...
const de_IdentityDescription = (output, context) => {
  return (0, _smithyClient.take)(output, {
    CreationDate: _ => (0, _smithyClient.expectNonNull)((0, _smithyClient.parseEpochTimestamp)((0, _smithyClient.expectNumber)(_))),
    IdentityId: _smithyClient.expectString,
    LastModifiedDate: _ => (0, _smithyClient.expectNonNull)((0, _smithyClient.parseEpochTimestamp)((0, _smithyClient.expectNumber)(_))),
    Logins: _smithyClient._json
  });
};
const de_ListIdentitiesResponse = (output, context) => {
  return (0, _smithyClient.take)(output, {
    Identities: _ => de_IdentitiesList(_, context),
    IdentityPoolId: _smithyClient.expectString,
...
const throwDefaultError = (0, _smithyClient.withBaseException)(_CognitoIdentityServiceException.CognitoIdentityServiceException);
const buildHttpRpcRequest = async (context, headers, path, resolvedHostname, body) => {
  ...
  return new _protocolHttp.HttpRequest(contents);
};
