...
const getRuntimeConfig = config => {
  return {
    ...
    endpointProvider: (config === null || config === void 0 ? void 0 : config.endpointProvider) ?? _endpointResolver.defaultEndpointResolver,
    ...
    serviceId: (config === null || config === void 0 ? void 0 : config.serviceId) ?? "Cognito Identity",
